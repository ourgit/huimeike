<!-- 注册页面 -->
<template>
	<view class="forgot" :style="{ backgroundImage:'url('+bgImage+')'}">
		...
		<view class="form" :style="{ backgroundImage:'url('+formImage+')'}">
			...
			<view class="input" style="margin-top: 15px;">
				<text class="icon bold">&#xe60f;</text>
				<input type="text" placeholder="请设置新密码" placeholder-style="color:#b2b2b2" v-model="password" />
			</view>	
			<button class="submit" @click="modify" :disabled="isDisable">提交</button>
		</view>
	</view>
</template>
